...
router.get("/sales/chart", adminController.getChartSales)
router.get("/sales/report", adminController.getReportSales)
router.get("/sales/report/search", adminController.getReportSalesSearch)
